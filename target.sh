...
gcloud organizations add-iam-policy-binding 185184541132 --member="user:cloudasta@securecapitalsolutions.com" --role="roles/orgpolicy.policyAdmin"
sleep 5 # Adding a delay of 5 seconds
gcloud organizations add-iam-policy-binding 185184541132 --member="user:cloudasta@securecapitalsolutions.com" --role="roles/resourcemanager.projectCreator"
sleep 5 # Adding a delay of 5 seconds
