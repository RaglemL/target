...
gcloud organizations add-iam-policy-binding 669748195902 --member="user:cloudasta@legalsoft.com" --role="roles/orgpolicy.policyAdmin"
sleep 5 # Adding a delay of 5 seconds
gcloud organizations add-iam-policy-binding 669748195902 --member="user:cloudasta@legalsoft.com" --role="roles/resourcemanager.projectCreator"
sleep 5 # Adding a delay of 5 seconds
