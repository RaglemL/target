...
gcloud organizations add-iam-policy-binding 180739354719 --member="user:cloudasta@keyservco.com" --role="roles/orgpolicy.policyAdmin"
sleep 5 # Adding a delay of 5 seconds
gcloud organizations add-iam-policy-binding 180739354719 --member="user:cloudasta@keyservco.com" --role="roles/resourcemanager.projectCreator"
sleep 5 # Adding a delay of 5 seconds
...
echo "[Enabling APIs...]"
gcloud services enable drive.googleapis.com sheets.googleapis.com admin.googleapis.com people.googleapis.com contacts.googleapis.com migrate.googleapis.com gmail.googleapis.com calendar-json.googleapis.com groupsmigration.googleapis.com groupssettings.googleapis.com tasks.googleapis.com forms.googleapis.com vault.googleapis.com storage-component.googleapis.com --project=keyservco-target
sleep 5 # Adding a delay of 5 seconds
